...
namespace AppUI
{
    public class ParentForm : Form
    {
        ...
        public ToolStripMenuItem menuItemTools, menuItemTools_Recover, menuItemTools_Search, menuItemsTools_InitializeDB;
        ...
        private void ParentForm_Shown(object sender, EventArgs e)
        {
            ...
            if (!MainThread.CheckFileExistence())
            {
                ...
                {
                    UpdaterClass updater = new UpdaterClass("Bible");
                }
            }
