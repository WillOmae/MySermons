...
namespace AppEngine
{
    public class FileNames
    {
        ...
        static public readonly string TempVersionFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"MySermons\Required Files\tempVersion");
        static public readonly string PermVersionFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"MySermons\Required Files\Version");
        ...
        public static readonly string uriVersion = downloadLocation + "Version";
...
//System.Windows.Forms.Application.StartupPath + @"\bin\";
//https://sourceforge.net/projects/mysermons/files/
//https://github.com/WillOmae/MySermons/raw/master/Downloads/
//https://github.com/WillOmae/MySermons/raw/master/Downloads/MySermons.exe